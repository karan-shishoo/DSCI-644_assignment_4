...
public abstract class DNDHelper {
	private DNDHelperProduct dNDHelperProduct = new DNDHelperProduct();
	...
	public void deinitialize(){
		if (getDragSourceListener() != null) {
			dNDHelperProduct.destroyDragGestreRecognizer(this);
